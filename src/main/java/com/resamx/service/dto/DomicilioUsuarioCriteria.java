...
/**
 * Criteria class for the {@link com.resamx.domain.DomicilioUsuario} entity. This class is used
 * in {@link com.resamx.web.rest.DomicilioUsuarioResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /domicilio-usuarios?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class DomicilioUsuarioCriteria implements Serializable, Criteria {
    ...
    public DomicilioUsuarioCriteria() {
    }

    public DomicilioUsuarioCriteria(DomicilioUsuarioCriteria other) {
    ...
    @Override
    public DomicilioUsuarioCriteria copy() {
        return new DomicilioUsuarioCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DomicilioUsuarioCriteria that = (DomicilioUsuarioCriteria) o;
        return
    ...
    public String toString() {
        return "DomicilioUsuarioCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
