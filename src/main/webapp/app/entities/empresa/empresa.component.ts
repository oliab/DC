...
export class EmpresaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.empresaService
      ...
      .subscribe(
        (res: HttpResponse<IEmpresa[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInEmpresas(): void {
    this.eventSubscriber = this.eventManager.subscribe('empresaListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IEmpresa[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
