...
export class DatosUsuarioComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.datosUsuarioService
      ...
      .subscribe(
        (res: HttpResponse<IDatosUsuario[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDatosUsuarios(): void {
    this.eventSubscriber = this.eventManager.subscribe('datosUsuarioListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDatosUsuario[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
