...
import com.resamx.service.UserService;
import com.resamx.service.dto.PasswordChangeDTO;
import com.resamx.service.dto.UserDTO;
import com.resamx.web.rest.vm.KeyAndPasswordVM;
import com.resamx.web.rest.vm.ManagedUserVM;
...
import static com.resamx.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
public class AccountResourceIT {
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.SUPERVISOR));
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.SUPERVISOR));
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.SUPERVISOR));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.SUPERVISOR).get());
    }
