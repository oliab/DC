...
import { CatSucursalComponent } from 'app/entities/cat-sucursal/cat-sucursal.component';
...
describe('Component Tests', () => {
  describe('CatSucursal Management Component', () => {
    let comp: CatSucursalComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CatSucursalComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.catSucursals && comp.catSucursals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
